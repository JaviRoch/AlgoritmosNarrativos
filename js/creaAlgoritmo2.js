...
//Función de extración de datos según tipos
function extracDatTipo(varT){
	...
	$.getJSON("../datos/data.json", function(datos){
		...
		var temp = datos.filter(datos => datos.hecho0 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando0"]);
		}
		var temp = datos.filter(datos => datos.hecho1 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando1"]);
		}
		var temp = datos.filter(datos => datos.hecho2 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando2"]);
		}
		var temp = datos.filter(datos => datos.hecho3 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando3"]);
		}
		var temp = datos.filter(datos => datos.hecho4 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando4"]);
		}
		var temp = datos.filter(datos => datos.hecho5 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando5"]);
		}
		var temp = datos.filter(datos => datos.hecho6 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando6"]);
		}
		var temp = datos.filter(datos => datos.hecho7 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando7"]);
		}
		var temp = datos.filter(datos => datos.hecho8 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando8"]);
		}
		var temp = datos.filter(datos => datos.hecho9 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando9"]);
		}
		var temp = datos.filter(datos => datos.hecho10 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando10"]);
		}
		var temp = datos.filter(datos => datos.hecho11 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando11"]);
		}
		var temp = datos.filter(datos => datos.hecho12 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando12"]);
		}
		var temp = datos.filter(datos => datos.hecho13 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando13"]);
		}
		var temp = datos.filter(datos => datos.hecho14 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando14"]);
		}
		var temp = datos.filter(datos => datos.hecho15 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando15"]);
		}
		var temp = datos.filter(datos => datos.hecho16 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando16"]);
		}
		var temp = datos.filter(datos => datos.hecho17 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando17"]);
		}
		var temp = datos.filter(datos => datos.hecho18 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando18"]);
		}
		var temp = datos.filter(datos => datos.hecho19 == varT);
		for (var i = 0; i < temp.length; i++) {
			extrac.push(temp[i]["comando19"]);
		}
		console.log(extrac);
		return extrac;
		});
...
$(document).ready(function(){
	...
	$("#buttonLugar").click(function(){
				...
				var tipo = "Lugares";
				var lugaresExtra = extracDatTipo(tipo);
